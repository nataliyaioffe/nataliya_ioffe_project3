...
app.data = {
    ...
    backgrounds: [
        ...
        { bgSource: "<img src='./images/bench-accounting-49909-unsplash.jpg' alt='RANDOM ALT TEXT 11'>" },
        { bgSource: "<img src='./images/carolinie-cavalli-99609-unsplash.jpg' alt='RANDOM ALT TEXT 12'>"},
        { bgSource: "<img src='./images/chrissie-kremer-566235-unsplash.jpg' alt='RANDOM ALT TEXT 13'>" },
        { bgSource: "<img src='./images/danielle-macinnes-51592-unsplash.jpg' alt='RANDOM ALT TEXT 14'>" },
        { bgSource: "<img src='./images/davies-designs-379022-unsplash.jpg' alt='RANDOM ALT TEXT 15'>" },
        { bgSource: "<img src='./images/dominik-schroder-14534-unsplash.jpg' alt='RANDOM ALT TEXT 16'>" },
        { bgSource: "<img src='./images/galina-n-205299-unsplash.jpg' alt='RANDOM ALT TEXT 17'>" },
        { bgSource: "<img src='./images/joel-peel-131757-unsplash.jpg' alt='RANDOM ALT TEXT 18'>" },
        { bgSource: "<img src='./images/kumiko-shimizu-629602-unsplash.jpg' alt='RANDOM ALT TEXT 19'>" },
        { bgSource: "<img src='./images/masaaki-komori-597700-unsplash.jpg' alt='RANDOM ALT TEXT 20'>" },
        { bgSource: "<img src='./images/masaaki-komori-654069-unsplash.jpg' alt='RANDOM ALT TEXT 21'>" },
        { bgSource: "<img src='./images/nordwood-themes-490552-unsplash.jpg' alt='RANDOM ALT TEXT 22'>" },
        { bgSource: "<img src='./images/paul-earle-39322-unsplash.jpg' alt='RANDOM ALT TEXT 23'>" },
        { bgSource: "<img src='./images/thomas-kinto-1057481-unsplash.jpg' alt='RANDOM ALT TEXT 24'>" },
        { bgSource: "<img src='./images/vitalis-hirschmann-504920-unsplash.jpg' alt='RANDOM ALT TEXT 25'>" }

    ]
}
// { bgSource: "<img src='./images/chrissie-kremer-566235-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/danielle-macinnes-51592-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/davies-designs-379022-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/dominik-schroder-14534-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/galina-n-205299-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/joel-peel-131757-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/kumiko-shimizu-629602-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/masaaki-komori-597700-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/masaaki-komori-654069-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/nordwood-themes-490552-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/paul-earle-39322-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/thomas-kinto-1057481-unsplash.jpg' alt='RANDOM ALT TEXT'>"},
// { bgSource: "<img src='./images/vitalis-hirschmann-504920-unsplash.jpg' alt='RANDOM ALT TEXT'>"}
...
app.init = function() {
    ...
    $("button").on("click", function() {
        ...
        if (app.bgLocked === false) {
            $(".background-image").fadeOut(500, function() {
                console.log("fadeout");
                app.getRandomBackground();
                setTimeout( function() {
